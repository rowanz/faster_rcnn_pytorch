...
def sentence_preprocess(phrase):
    ...
    return phrase.lower().translate(NO_PUNCT)
    # Old, python2 code
...
if __name__ == '__main__':
    ...
    parser.add_argument('--object_input', default='../datasetv1_2/objects.json', type=str)
    parser.add_argument('--relationship_input', default='../datasetv1_2/relationships.json', type=str)
    parser.add_argument('--metadata_input', default='../datasetv1_2/image_data.json', type=str)
